...
cranberry = Ingredient.create(name: "Cranberry_special")
vodka = Ingredient.create!(name: "Vodka_special")
seabreeze = Cocktail.create!(name: 'seabreeze')

dose1 = Dose.new(description:'6cl')
dose1.ingredient = vodka
dose1.cocktail = seabreeze

dose2 = Dose.new(description:'15cl')
dose2.ingredient = cranberry
dose2.cocktail = seabreeze
